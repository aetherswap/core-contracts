...
describe('AetherPool', () => {
  ...
  let pool0: MockTimeAetherPool
  let pool1: MockTimeAetherPool
  ...
  let swapTargetCallee: TestAetherCallee
  let swapTargetRouter: TestAetherRouter
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeAetherPool, any]> => {
