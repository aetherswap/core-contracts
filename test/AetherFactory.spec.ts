...
describe('AetherFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as AetherFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('AetherPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('AetherPool')
